    ...
    <div class="row d-flex justify-content-center">
        ...
        <form action="" method="POST">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label" for="nomor_whatsapp">No Telephone</label><br>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="harga" id="harga" value="<?= number_format($data['harga']); ?>" disabled>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
