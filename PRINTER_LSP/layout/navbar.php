...
<body>
  <nav class="navbar navbar-expand-lg bg-body-tertiary navbar-light bg-navbar">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">Toko RUDI</a>
      ...
      <div class="collapse navbar-collapse " id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <?php endif; ?>
          <?php if (!isset($_SESSION["username"])) : ?>
            <a class="nav-link" href="register/index.php"><i class="fa-solid fa-arrow-right-to-bracket fa-address-card me-2" style="color: #000000;"></i>register</a>
